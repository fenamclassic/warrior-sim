...
class Weapon {
    constructor(player, item, enchant, tempenchant, offhand, twohand) {
        ...
        this.totalthreat = 0;
        this.totalprocdmg = 0;
        this.totalprocthreat = 0;
        this.data = [0,0,0,0,0,0,0,0];
        this.thunderfury = item.id === 19019;
    ...
    parryHaste() {
      if (this.timer > Math.round(this.speed * 1000 / this.player.stats.haste) * 0.6) {
        this.timer -= Math.round(this.speed * 1000 / this.player.stats.haste) * 0.4;
      } else if (this.timer > Math.round(this.speed * 1000 / this.player.stats.haste) * 0.2) {
